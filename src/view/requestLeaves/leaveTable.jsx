        ...
        {data.map((data, i) => {
          return (
            <tr>
              ...
              <td>
                <button className={data.reporting_person_approval ?  "btn btn-outline-danger" : "btn btn-outline-success" }  onClick={() => handleStatus(data)}>{data.reporting_person_approval ? "Reject": "Approve" }</button>
